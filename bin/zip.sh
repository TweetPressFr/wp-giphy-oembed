...
npx pot-to-php ./languages/goe.pot ./languages/goe-translations.php goe

# Remove any existing zip file
rm -f wp-giphy-oembed.zip

# Generate the plugin zip file
status "Creating archive..."
zip -r wp-giphy-oembed.zip \
	wp-giphy-oembed.php \
	lib/*.php \
	scripts/{main,i18n}/build/*.{js,css} \
	languages/goe-translations.php \
	readme.txt
